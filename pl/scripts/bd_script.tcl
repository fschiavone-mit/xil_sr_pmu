...
proc create_root_design { parentCell } {
  ...
  set m_axi_ctl [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 m_axi_ctl ]
  ...
  set m_axi_str [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 m_axi_str ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
   CONFIG.DATA_WIDTH {32} \
   CONFIG.HAS_BURST {0} \
  ...
  set dac0_rts [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:rfdc_rts_pins_rtl:1.0 dac0_rts ]

  set dac0_nco [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:rfdc_nco_pins_rtl:1.0 dac0_nco ]

  set adc0_rts [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:rfdc_rts_pins_rtl:1.0 adc0_rts ]

  set adc0_nco [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:rfdc_nco_pins_rtl:1.0 adc0_nco ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {m_axi_ctl:m_axi_str} \
   CONFIG.ASSOCIATED_RESET {m_axi_aresetn:m_axi_areset} \
 ] $m_axi_aclk
  ...
  set m_axi_areset [ create_bd_port -dir O -from 0 -to 0 -type rst m_axi_areset ]
  set ps_intr [ create_bd_port -dir I -from 15 -to 0 -type intr ps_intr ]
  set_property -dict [ list \
   CONFIG.PortWidth {16} \
 ] $ps_intr
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.ADC0_Outclk_Freq {180.000} \
    CONFIG.ADC0_PLL_Enable {true} \
    CONFIG.ADC0_Sampling_Rate {2.88} \
    CONFIG.ADC_Data_Width00 {2} \
    CONFIG.ADC_Data_Width02 {2} \
    CONFIG.ADC_Decimation_Mode00 {8} \
    CONFIG.ADC_Decimation_Mode02 {8} \
    CONFIG.ADC_NCO_Freq00 {-1.089} \
    CONFIG.ADC_NCO_Freq02 {-1.089} \
    ...
    CONFIG.DAC0_Outclk_Freq {180.000} \
    CONFIG.DAC0_PLL_Enable {true} \
    CONFIG.DAC0_Refclk_Freq {180.000} \
    CONFIG.DAC0_Sampling_Rate {2.88} \
    CONFIG.DAC_Data_Width00 {4} \
    CONFIG.DAC_Interpolation_Mode00 {8} \
    CONFIG.DAC_NCO_Freq00 {1.089} \
  ...
  connect_bd_intf_net -intf_net adc0_rts_0_1 [get_bd_intf_ports adc0_rts] [get_bd_intf_pins usp_rf_data_converter_0/adc0_rts]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m01_axis [get_bd_intf_ports m01_axis] [get_bd_intf_pins usp_rf_data_converter_0/m01_axis]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m03_axis [get_bd_intf_ports m03_axis] [get_bd_intf_pins usp_rf_data_converter_0/m03_axis]
